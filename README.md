...
Headers and footers will be required to run in the target language. Headers, footers, and map files for C, Python, Ruby, lisp, Prolog, and assembly for x86_64 FreeBSD are provided.
